...
2.  ติดตั้ง Web App API: นำโค้ดใน `/backend/Code.gs` ไปวางใน Google Apps Script พร้อมตั้งค่า `GEMINI_API_KEY` ในหน้าสคริปต์พร็อพเพอร์ตี้ และกด Deploy
3.  อัปโหลดโค้ดในโฟลเดอร์ `/src` ลงบอร์ด ESP32 (อย่าลืมเปลี่ยน URL ของ Web App API ให้ตรงกับของคุณ)
4.  เมื่อบอร์ดเริ่มทำงาน ให้เชื่อมต่อ Wi-Fi ชื่อ "SmartPlant_Setup" เพื่อตั้งค่าเครือข่ายอินเทอร์เน็ต
5.  ตรวจสอบสถานะ สั่งงาน และดูผลการวิเคราะห์จาก AI ผ่านแอปพลิเคชัน Blynk และ Google Sheets
